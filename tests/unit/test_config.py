...
@pytest.mark.parametrize(
    "test_calendar_id, expected",
    [("dude@gmail.com", True), ("abc123@group.calendar.google.com", True), ("error@group.calendar.google.com", False), (None, False),],
)
...
@pytest.mark.parametrize(
    "test_calendar_name, expected", [("Default", True), ("Calendar2", True), ("error@group.calendar.google.com", False), (None, False),],
)
